...
// MARK: - Get all reservations if user has the right token
const get = async (req, res, next) => {
  ...
  // MARK: - Get users reservations if user has the right token
  ...
  // MARK: - Post a reservation if user has the right token
const post =  async (req, res, next) => {
  ...
  // MARK: - Update a reservation if user has the right token
const put = async (req, res, next) => {
  ...
  // MARK: - Delete a reservation if user has the right token
